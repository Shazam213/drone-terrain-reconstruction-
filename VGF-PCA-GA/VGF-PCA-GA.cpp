...
int main()
{
    ...
    pcl::io::loadPCDFile ("CSite1_orig-utm.pcd", *search_cloud);
    ...
    sor.setLeafSize (1.00f, 1.00f, 1.00f);
    ...
    pcl::io::savePCDFile ("CSite1_orig-utm-downsampled.pcd", *filter_blob);
    ...
    pcl::io::savePCDFile ("CSite1_orig-utm-downsampled-pca.pcd", *cloud_normals);
    ...
    pcl::io::savePCDFile ("Concatenated.pcd", *cloud_with_normals);
